  ...
  return (
    <div className='grid md:grid-flow-col justify-between mx-2'>
      <div>
        ...
        <div className='text-2xl sm:text-3xl font-poppins'>{lang ? nameResume?.profession?.En : nameResume?.profession?.Zh}</div>
      </div>

      <div>
        <p className='text-xl sm:text-2xl font-poppins py-3 mb-2 mt-8 md:mt-0'>{lang ? "Download Resume" : "下载简历"}</p>
