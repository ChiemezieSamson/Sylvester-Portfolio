    ...
    <div className='py-20 xx:px-2 sm:px-4'>
      ...
      <ul className='py-10 grid sm:grid-cols-2 lg:grid-cols-3 justify-center items-center gap-4'>
        {MyProjects.map((project) => {
          return (
            <li key={project.id} className='my-5 shadow-sm shadow-[rgba(21,28,44,0.3)] rounded-xl'>
              <img src={project.project_image} alt={"project"} className='aspect-[16/10] rounded-xl'/>
